            ...
            <tr class="text-xs font-semibold tracking-wide text-left text-white uppercase bg-purple-600">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3 text-sm">Kertas A4</td>
                    <td class="px-4 py-3 text-sm">12 Mei 2024</td>
                    <td class="px-4 py-3 text-sm">20</td>
                    <td class="px-4 py-3 text-sm">Lembar</td>
                    <td class="px-4 py-3 text-sm">Rp20.000</td>
                    <td class="px-4 py-3 text-sm">Onsu</td>
                    <td class="px-4 py-3">
