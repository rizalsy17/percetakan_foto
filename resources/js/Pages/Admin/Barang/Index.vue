                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <div>
                          <p class="font-semibold">E-73938</p>
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">Bolpoin Standart</td>
                    <td class="px-4 py-3 text-sm">Rp3.000</td>
                    <td class="px-4 py-3 text-sm">Rp2.000</td>
                    <td class="px-4 py-3 text-sm">23</td>
                    <td class="px-4 py-3 text-sm">Dijual murah</td>
                    <td class="px-4 py-3 text-sm">Ons</td>
                    <td class="px-4 py-3">
