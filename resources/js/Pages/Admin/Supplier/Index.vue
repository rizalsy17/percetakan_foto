                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <div>
                          <p class="font-semibold">Wulandari</p>
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">PT Karya</td>
                    <td class="px-4 py-3 text-sm">0893892929238</td>
                    <td class="px-4 py-3 text-sm">Banten</td>
                    <td class="px-4 py-3 text-sm">Jln Tangerang No 12 Banten</td>
                    <td class="px-4 py-3">
