                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <div>
                          <p class="font-semibold">K-73938</p>
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">Karyawan</td>
                    <td class="px-4 py-3 text-sm">karyawan@admin.com</td>
                    <td class="px-4 py-3 text-sm">01281291291</td>
                    <td class="px-4 py-3 text-sm">Jakarta</td>
                    <td class="px-4 py-3">
